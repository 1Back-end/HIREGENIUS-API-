...
class ConfigClass(BaseSettings):
    ...
    ADMIN_KEY: str = get_secret("ADMIN_KEY", "HIREGENIUS_2025")
    ADMIN_USERNAME: str = get_secret("ADMIN_USERNAME", "HIREGENIUS_ADMIN")
    ADMIN_PASSWORD: str = get_secret("ADMIN_PASSWORD", "HgA1B2C3D4")
    ...
    SQLALCHEMY_DATABASE_URL: str = get_secret("SQLALCHEMY_DATABASE_URL", 'postgresql://postgres:2002@localhost:5432/hiregenius_db')
    ...
    PROJECT_NAME: str = get_secret("PROJECT_NAME", "HIREGENIUS API")
    ...
    EMAILS_FROM_NAME: Optional[str] = get_secret("EMAILS_FROM_NAME", "API ERP")
